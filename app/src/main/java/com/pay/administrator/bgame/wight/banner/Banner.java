...
import com.pay.administrator.bgame.wight.banner.listener.OnBannerClickListener;
import com.pay.administrator.bgame.wight.banner.listener.OnBannerListener;
import com.pay.administrator.bgame.wight.banner.loader.ImageLoaderInterface;
import com.pay.administrator.bgame.wight.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.drawable.white_radius);
        typedArray.recycle();
    }
