...
public class HotCallAdapter extends BaseQuickAdapter<TagBean.DataBean, BaseViewHolder> {


    public HotCallAdapter(int layoutIds, List<TagBean.DataBean> countryDatas) {
